...
export function ShirtMockup({
  ...
  className?: string
  /** The print is a next/image, so it needs the caller's real display width.
   *  The default is card-sized; the design page renders this at ~600px and
   *  would otherwise download a thumbnail and stretch it. */
  sizes?: string
