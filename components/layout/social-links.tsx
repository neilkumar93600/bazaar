...
/** The site's official social profiles, in one place because both the footer
 *  and the hero prompt card render them.
 *
 *  Configurable via environment variables with production fallbacks.
 *  lucide dropped its brand icons in v1, hence the clean inline SVGs.
 */
export const SOCIAL_LINKS: {
  ...
  {
    label: "X (Twitter)",
    href: envValue("NEXT_PUBLIC_X_URL") ?? "https://x.com/shirtbazaar",
    icon: (
  ...
  {
    label: "Instagram",
    href: envValue("NEXT_PUBLIC_INSTAGRAM_URL") ?? "https://instagram.com/shirtbazaar",
    icon: (
      <svg
        width="14"
        height="14"
  ...
  {
    label: "TikTok",
    href: envValue("NEXT_PUBLIC_TIKTOK_URL") ?? "https://tiktok.com/@shirtbazaar",
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" className="fill-current">
  ...
  {
    label: "YouTube",
    href: envValue("NEXT_PUBLIC_YOUTUBE_URL") ?? "https://youtube.com/@shirtbazaar",
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" className="fill-current">
  ...
  {
    label: "Facebook",
    href: envValue("NEXT_PUBLIC_FACEBOOK_URL") ?? "https://facebook.com/shirtbazaar",
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" className="fill-current">
